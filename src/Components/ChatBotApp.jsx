...
const ChatBotApp = ({onGoBack, chats, setChats, activeChat, setActiveChat, onNewChat }) => {
    ...
    const sendMessage = async () => {
        ...
        if(!activeChat){
            ...
            const updatedMessageWithResponse = [...updatedMessages, newResponse]
        ...
        <div className="chat-app">
            <div className={`chat-list ${showChatList ? "show" : "" }`}>
                <div className="chat-list-header">
                    ...
                    { showChatList && <i className="bx bx-x-circle" onClick={() => {setShowChatList(false)}}></i> }
                </div>
                {chats.map((chat) => (
                    <div key={chat.id} className={`chat-list-item 
                                    ${chat.id === activeChat ? 'active' : ''}`} onClick={() => handleSelectChat(chat.id)}>
            ...
            <div className="chat-window">
                ...
                <form className="msg-form" 
                    ...
                    <i className="fa-solid fa-face-smile emoji" onClick={() => 
                            setShowEmojiPicker((prev) => !prev)}></i>
                    {showEmojiPicker && (
